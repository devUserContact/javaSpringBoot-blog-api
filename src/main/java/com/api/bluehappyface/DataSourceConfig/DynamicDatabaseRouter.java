...
@Configuration
@EnableJpaRepositories(basePackages = "com.api.bluehappyface", transactionManagerRef = "transactionManager", entityManagerFactoryRef = "entityManager")
...
public class DynamicDatabaseRouter {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder) {
        return builder.dataSource(dataSource()).packages("com.api.bluehappyface").build();
    }
